...
export default class PhotoViewer extends Component {
  componentDidMount() {
    ...
    document.getElementById(`pg-photo-container-${this.props.id}`).appendChild(this.props.texture.image);
  }
  ...
  render() {
    ...
    return (
      <div style={containerStyles} className="photo-viewer-container" id={`pg-photo-container-${this.props.id}`} />
    );
  }
}
